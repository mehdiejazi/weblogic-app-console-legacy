...
(function(){
    ...
    else if(u(b)&&T(b))for(d in b)a.setAttribute(d,b[d]);return e
    }
    function ja(a){
    return Ia(a)?
    a:[a]
...
function Ca(a,b){
    ...
    for(g=0;g<c.length;g++)if(d=c[g],e=D[d[0]],f=d[1],c[g+1]&&a<=(e*f[f.length-1]+D[c[g+1][0]])/2)break;e===D[Da]&&a<5*e&&(f=[1,2,5]);
...
L={
    ...
    chart:{
        ...
        spacing:[10,10,15,10],
        style:{
            fontFamily:'"BYekan", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif',
            fontSize:"12px"
        },
...
attr:function(a,b){
    ...
    [c]||c:c==="strokeWidth"&&(c="stroke-width"),q=w(g,c)||this[c]||0,c!=="d"&&c!=="visibility"&&c!=="fill"&&(q=parseFloat(q));
        ...
        for(c in a)if(j=!1,d=a[c],e=k[c]&&k[c].call(this,d,c),e!==!1){
            ...
            else if(c==="x"&&h==="text")for(e=0;e<g.childNodes.length;e++)f=g.childNodes[e],w(f,"x")===
                w(g,"x")&&w(f,"x",d);
...
color:function(a,b,c){
    ...
    if(g){
        ...
        for(m in c)m!==
            "id"&&p.push(m,c[m]);for(m in j)p.push(j[m]);p=p.join(",");
...
label:function(a,b,c,d,e,f,g,h,i){
    ...
    var p=this,q=p.g(i),o=p.text("",0,0,g).attr({
    zIndex:1
}),B,O,r=0,da=3,lb=0,Oa,Ha,E,H,C=0,Xa={},w,g=q.attrSetters,y;
K(q,"add",m);
g.width=function(a){
    Oa=a;
    return!1
...
if(!W&&!ca){
    ...
    pathToVML:function(a){
        for(var b=a.length,c=[],d;b--;)if(ra(a[b]))c[b]=t(a[b]*10)-5;
            else if(a[b]==="Z")c[b]="x";
...
color:function(a,b,c,d){
    ...
    if(i){
        ...
        if(c==="fill")if(i==="gradient")c=m.x1||m[0]||0,a=m.y1||m[1]||0,p=m.x2||m[2]||0,m=m.y2||m[3]||0,r='angle="'+(90-R.atan((m-a)/(p-c))*180/xa)+'"',v();
            else{
...
init:function(a,b){
    ...
    for(f in d)K(this,f,d[f]);if(this.isLog)this.val2lin=ma,this.lin2val=fa
        },
...
defaultLabelFormatter:function(){
    ...
    else if(f&&a>=1E3)for(;f--&&g===v;)c=Math.pow(1E3,f+1),a>=c&&e[f]!==null&&(g=Aa(b/c,-1)+e[f]);
    ...
    n(a.series,function(c){
        if(c.visible||
            ...
            if(a.isXAxis){
                ...
                if(u(d))if(a.dataMin>=d)a.dataMin=d,a.ignoreMinPadding=!0;
...
destroy:function(a){
    ...
    a||$(b);
    for(d in c)Ka(c[d]),c[d]=null;n([b.ticks,b.minorTicks,b.alternateBands],function(a){
        Ka(a)
        });
    ...
    runPointActions:function(a){
        ...
        if(d&&this.options.tooltip.shared&&(!g||!g.noSharedTooltip)){
            ...
            for(i=0;i<h;i++)if(c[i].visible&&
                c[i].options.enableMouseTracking!==!1&&!c[i].noSharedTooltip&&c[i].tooltipPoints.length&&(b=c[i].tooltipPoints[k])&&b.series)b._dist=M(k-b.clientX),j=J(j,b._dist),e.push(b);for(h=e.length;h--;)e[h]._dist>j&&e.splice(h,1);
...
inClass:function(a,b){
    for(var c;a;){
        if(c=
            w(a,"class"))if(c.indexOf(b)!==-1)return!0;
...
Q.prototype={
    ...
    init:function(a,b){
        ...
        if(ca)b.animation=!1;
        d=b.events;
        for(c in d)K(this,c,d[c]);if(d&&d.click||b.point&&b.point.events&&b.point.events.click||b.allowPointSelect)a.runTrackerClick=!0;
        this.getColor();
        this.getSymbol();
...
getExtremes:function(){
    ...
    for(l=0;l<d;l++)if(j=b[l],k=c[l],i=k!==null&&k!==v&&(!a.isLog||k.length||k>0),j=this.getExtremesFromAll||this.cropped||(b[l+1]||j)>=h&&(b[l-1]||j)<=g,i&&j)if(i=k.length)for(;i--;)k[i]!==null&&(e[f++]=k[i]);else e[f++]=k;this.dataMin=o(void 0,Ja(e));
...
drawPoints:function(){
    ...
    if(l.enabled||this._hasPointMarkers)for(f=b.length;f--;)if(g=
        b[f],d=P(g.plotX),e=g.plotY,k=g.graphic,i=g.marker||{},a=l.enabled&&i.enabled===v||i.enabled,m=c.isInsidePlot(t(d),e,c.inverted),a&&e!==v&&!isNaN(e)&&g.y!==null)if(a=g.pointAttr[g.selected?"select":""],h=a.r,i=o(i.symbol,this.symbol),j=i.indexOf("url")===0,k)k.attr({
...
getAttribs:function(){
    ...
    for(g=i.length;g--;){
        ...
        if(h.options)for(q in l)u(c[l[q]])&&(f=!0);if(f){
            c=c||{};
...
update:function(a,b){
    ...
    this.remove(!1);
    for(f in e)e.hasOwnProperty(f)&&(this[f]=v);s(this,X[a.type||d].prototype);
    this.init(c,a);
    o(b,!0)&&c.redraw(!1)
    },
destroy:function(){
    ...
    if(d.enabled||a._hasPointLabels)a.dlProcessOptions&&a.dlProcessOptions(d),h=a.plotGroup("dataLabelsGroup","data-labels",a.visible?"visible":"hidden",d.zIndex||6),f=d,n(b,function(b){
        ...
        if(k&&!j)b.dataLabel=k.destroy();
            ...
            if(k)if(u(g))k.attr({
                ...
                for(m in k)k[m]===v&&delete k[m];k=b.dataLabel=a.chart.renderer[j?"text":"label"](g,0,-999,null,null,null,d.useHTML).attr(k).css(s(d.style,c&&{
                    cursor:c
...
G=ha(Q,{
    ...
    getSegments:function(){
        ...
        if(this.options.stacking&&!this.cropped){
            ...
            for(p in f)f[p].total!==null&&c.push(+p);c.sort(function(a,b){
                return a-b
                });
            n(c,function(a){
